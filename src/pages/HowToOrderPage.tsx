...
const STEPS = [
  ...
  },
  {
    ...
    subtitle: "We respond during business hours (10 AM–Midnight BST).",
    content: [
  ...
  },
  {
    ...
    content: [
      ...
      "We complete activation on WhatsApp. 30-day warranty included on all orders.",
    ],
  },
];
...
const FAQS = [
  {
    ...
    a: "Message us on WhatsApp. Tell us what you want to do (write, design, code, research, etc.) and your budget. We'll recommend the best tool on WhatsApp.",
  },
  {
  ...
  },
  {
    ...
    a: "After receiving your payment screenshot on WhatsApp, we verify the transaction and begin setting up your account. For shared accounts: 5–30 minutes. For personal accounts: 2–4 hours. We complete activation on WhatsApp.",
  },
  {
