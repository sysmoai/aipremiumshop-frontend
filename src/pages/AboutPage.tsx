...
export default function AboutPage() {
  return (
    <PageLayout>
      <SEOHead
        title="About AI Premium Shop — Bangladesh AI Subscriptions Since 2024"
        description="AI Premium Shop — Bangladesh's WhatsApp-first AI subscription store. customers since 2024 with 80 tools including ChatGPT, Claude, Midjourney. Pay with bKash/Nagad. Real human support, 10 AM–Midnight BST."
      ...
      <section className="max-w-5xl mx-auto px-4 md:px-8 py-14">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-16">
          ...
          >
            ...
            <p className="text-sm leading-relaxed mb-4" style={{ color: "#c9ceda" }}>
              AI Premium Shop (AIPS) has been serving Bangladeshi customers since 2024 with premium AI subscriptions. Founded by Emon Hossain, AIPS delivers ChatGPT, Claude, Midjourney, and more via WhatsApp-first sales with bKash/Nagad payments.
            </p>
          ...
          >
            ...
            <p className="text-sm leading-relaxed" style={{ color: "#c9ceda" }}>
              All plans come with 30-day replacement warranty, WhatsApp response during business hours, and local payment via bKash, Nagad, Rocket, or bank transfer.
            </p>
          </motion.div>
        </div>
        ...
        >
          ...
          <p className="text-sm leading-relaxed" style={{ color: "#c9ceda" }}>
            Our team is available 10 AM to Midnight, 7 days a week. We respond during business hours (10 AM–Midnight BST). You always talk to a real human, not a bot.
          </p>
        </motion.div>
