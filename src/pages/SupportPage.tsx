...
const FAQS = [
  ...
  },
  {
    ...
    a: "Yes! Join our WhatsApp Community to get AI tips, product updates, exclusive discount codes, and connect with AI users in Bangladesh.",
  },
  {
  ...
  return (
    <PageLayout>
      ...
      <script
        ...
        dangerouslySetInnerHTML={{ __html: schemaJson(faqSchema(FAQS)) }}
      />
      ...
      <section className="max-w-4xl mx-auto px-4 md:px-8 py-14">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 mb-12">
          ...
          >
            ...
            <div className="text-xs mt-2 font-medium" style={{ color: "#25d366" }}>WhatsApp: business hours</div>
          </motion.div>
          ...
          >
            ...
            <div className="text-xs" style={{ color: "#c9ceda" }}>our community</div>
