...
const SECTIONS = [
  ...
  },
  {
    ...
    content:
      "Message us on WhatsApp at +880 1865-385348 within the eligible timeframe. Include your order details (which tool, when you ordered, payment amount) and describe the issue you're experiencing. We'll review your request and respond promptly during business hours.",
  },
  {
    icon: Star,
    color: "#8b5cf6",
      ...
      <section className="max-w-3xl mx-auto px-4 md:px-8 py-14">
        ...
        >
          ...
          <p className="text-sm mb-6" style={{ color: "#c9ceda" }}>
            Message us on WhatsApp right away. We respond promptly during business hours and resolve all genuine issues without hassle.
          </p>
