...
const BRAND_META: Record<string, {
  ...
  "freepik-premium-bangladesh": {
    ...
    faqs: [
      ...
      { q: "Is Freepik Premium safe to buy through AIPS?", a: "Yes. AIPS provides working access with a 30-day replacement warranty. We have served our customers since 2024." },
  ...
  "kling-ai-bangladesh": {
    ...
    faqs: [
      ...
      { q: "Is Kling AI safe to buy through AIPS?", a: "Yes. AIPS provides working access with a 30-day replacement warranty. We have served our customers since 2024." },
      { q: "How do I buy without a credit card?", a: "Message AI Premium Shop on WhatsApp (+880 1865-385348). Pay with bKash, Nagad, or Rocket. Receive your login in 5–30 minutes." },
  ...
  "synthesia-bangladesh": {
    ...
    faqs: [
      ...
      { q: "Is Synthesia safe to buy through AIPS?", a: "Yes. AIPS provides working access with a 30-day replacement warranty. We have served our customers since 2024." },
      { q: "How do I buy without a credit card?", a: "Message AI Premium Shop on WhatsApp (+880 1865-385348). Pay with bKash, Nagad, or Rocket. Receive your login in 5–30 minutes." },
  ...
  "windsurf-bangladesh": {
    ...
    faqs: [
      ...
      { q: "Is Windsurf safe to buy through AIPS?", a: "Yes. AIPS provides working access with a 30-day replacement warranty. We have served our customers since 2024." },
      { q: "How do I buy without a credit card?", a: "Message AI Premium Shop on WhatsApp (+880 1865-385348). Pay with bKash, Nagad, or Rocket. Receive your login in 5–30 minutes." },
  ...
  "capcut-pro-bangladesh": {
    ...
    faqs: [
      ...
      { q: "Is CapCut Pro safe to buy through AIPS?", a: "Yes. AIPS provides working CapCut Pro access — shared plans split a legitimate subscription, personal plans are dedicated accounts. All plans include a 30-day replacement warranty. We have served our customers since 2024." },
    ...
    <PageLayout>
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: schemaJson(breadcrumbSchema([
            { name: "Home", href: "/" },
        ...
        <div className="mb-14 p-6 rounded-2xl border border-white/10" style={{ backgroundColor: "#151b3d" }}>
          ...
          <ol className="space-y-3 text-sm" style={{ color: "#c9ceda" }}>
            ...
            <li className="flex gap-3">
              ...
              <span>Receive access instructions. Delivery: {cheapest?.deliverySLA ?? "5–30 min"}. 30-day warranty included.</span>
            </li>
          </ol>
          <a
        ...
        {(() => {
          const qa = [
            ...
            },
            {
              ...
              a: `Yes. AI Premium Shop (AIPS) offers official ${meta.displayName} subscriptions in Bangladesh. All plans are delivered within 5–30 minutes via WhatsApp after payment confirmation. We have served our customers since 2024.`,
            },
            {
            ...
            },
            {
              ...
              a: `Yes. AIPS provides working paid ${meta.displayName} subscriptions — shared plans split a legitimate subscription, personal plans are dedicated accounts. All plans include a 30-day replacement warranty. Serving customers since 2024.`,
            },
          ];
          return (
            <div className="mb-14">
