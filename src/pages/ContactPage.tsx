  ...
  return (
    <PageLayout>
      <SEOHead
        ...
        description="Contact AI Premium Shop in Dhaka, Bangladesh. WhatsApp +880 1865-385348, Messenger, or email. Under prompt response during business hours, 10 AM to Midnight BST."
      ...
      <section className="max-w-4xl mx-auto px-4 md:px-8 py-14">
        ...
        >
          ...
          <p className="text-lg max-w-xl" style={{ color: "#c9ceda" }}>
            The fastest way to reach us is WhatsApp. We respond during business hours (10 AM–Midnight BST).
          </p>
        </motion.div>
        ...
        >
          ...
          {submitted ? (
            ...
            >
              ...
              <p className="text-sm mb-6" style={{ color: "#c9ceda" }}>
                Your message has been pre-filled. Just tap Send in WhatsApp and we&apos;ll reply during business hours.
              </p>
              <button
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <p className="text-xs text-center" style={{ color: "#c9ceda" }}>
                This will open WhatsApp with your message pre-filled. We respond during business hours (10 AM–Midnight BST).
              </p>
            </form>
          )}
        </motion.div>
        ...
        >
          <div className="p-6 rounded-2xl border border-white/10" style={{ backgroundColor: "#151b3d" }}>
            ...
            <p className="text-xs mt-3" style={{ color: "#f4b942" }}>WhatsApp response during business hours</p>
          </div>
          <div className="p-6 rounded-2xl border border-white/10" style={{ backgroundColor: "#151b3d" }}>
