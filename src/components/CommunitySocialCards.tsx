...
const SOCIAL_CARDS = [
  {
    icon: MessageCircle,
    label: "WhatsApp",
    desc: "Order in 2 minutes. Get support during business hours. The fastest way to buy AI tools.",
    badge: "PRIMARY",
  ...
  },
  {
    ...
    desc: "Join our community. Get exclusive deals, renewal reminders, and AI tips from other users.",
    badge: "FREE TO JOIN",
