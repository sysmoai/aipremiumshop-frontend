...
export function CookieBanner({ onConsent }: CookieBannerProps) {
  ...
  const { setCookieBanner } = useBottomSafe();
  ...
  return (
    <div
      className="fixed bottom-0 inset-x-0 z-[60] flex items-center justify-between px-4 md:px-8 gap-4"
      style={{
